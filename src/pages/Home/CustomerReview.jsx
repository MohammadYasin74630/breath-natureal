...
function CustomerCard({ img, className, children }) {
  return (
  ...
  return (
    <>
      ...
      <div className="grid lg:grid-cols-2 xl:grid-cols-3 gap-8">
        <CustomerCard img={customer2}>Maxn Raval</CustomerCard>
        <CustomerCard img={customer3}>venely k</CustomerCard>
        <CustomerCard className="lg:max-xl:col-span-2" img={customer4}>Lii thakur</CustomerCard>
      </div>
    </>
  );
}
